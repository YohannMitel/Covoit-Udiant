<?php
    ...
    if(!isset($_SESSION["nom"])){
      header("Location: https://rt-projet.pu-pm.univ-fcomte.fr/~ymitel/sae23fin-en/connexion.php/connexion.php");
      exit(); 
    $nom = $_SESSION['nom'];
    }
    ...
    $csvFile = 'https://rt-projet.pu-pm.univ-fcomte.fr/~ymitel/sae23fin-en/csv/edt.csv';
