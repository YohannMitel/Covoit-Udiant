  ...
  <div class="center">
    ...
    <form action="creaequipe.php" method="get">
      <div class="texte">
        ...
        <span></span>
        <label for="nomequip">Name of the crew</label>
      </div>
      <div class="texte">
        <input type="number" name="nbplace" min="1" max="7" required>
        <span></span>
        <label for="nbplace">number of attendees</label>
      </div>
      <div id="app">
        <div class="texte">
          <input v-model="trajet" type="number" name="nbtrajet" min="1" max="5" required>
          <span></span>
          <label for ="nbtrajet">Number of routes</label>
        </div>
        ...
        <div class="texte" v-if="trajet > 0 ">
          ...
          <span></span>
          <label for ="trajet1">Route n°1</label>
        ...
        <div class="texte" v-if="trajet > 1">
          ...
          <span></span>
          <label for ="trajet2">Route n°2</label>
        ...
        <div class="texte" v-if="trajet > 2">
          ...
          <span></span>
          <label for ="trajet3">Route n°3</label>
        ...
        <div class="texte" v-if="trajet > 3">
          ...
          <span></span>
          <label for ="trajet4">Route n°4</label>
        ...
        <div class="texte" v-if="trajet > 4">
          ...
          <span></span>
          <label for ="trajet5">Route n°5</label>
